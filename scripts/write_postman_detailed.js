  ...
  makeSection('Admin Users', 'User insights and moderation actions.', [
    {
      ...
      auth: 'admin',
      description: describe(
        'Counts total/active/suspended users and monthly deltas, plus recent users and top payers.',
        null,
        fmt({
          summary: {
            totalUsers: { value: 1024, monthlyChangePct: 12.5 },
            activeUsers: { value: 980 },
            suspendedUsers: { value: 44 },
            avgMonthlyRating: { value: 4.85, monthlyChangePct: 3.1 },
          },
          recentUsers: [
            {
              id: '6500seller',
    ...
    },
    {
      ...
      query: [
        { key: 'page', value: '1' },
        { key: 'limit', value: '20' },
        { key: 'roles', value: 'seller' },
        { key: 'status', value: 'active' },
        { key: 'search', value: 'hanan' },
      ],
      description: describe(
        'Supports `email`, `username`, `role(s)`, `status`, auth `method`, `fields`, `sortBy`, `sortDir`, `skip`, `limit`. Returns enriched rows with counts and wallet info.',
        null,
        fmt({
          docs: [
            {
  ...
  makeSection('Admin Listings', 'Content review workflow for listings.', [
    {
      ...
      description: describe(
        'Aggregates seller info, promotion snapshot, offer counts, and supports extra filters (`sellerType`, `occupation`, `method`).',
        null,
        fmt({
          docs: [
            {
    ...
    },
    {
      ...
      auth: 'admin',
      description: describe(
        'Returns listing plus seller info, promotion snapshot, budget type, and enriched offers (bidder name, phone, profile image).',
        null,
        fmt({
          listing: {
            _id: '6501abcdef1234567890abcd',
          ...
          offers: [
            {
              ...
              status: 'pending',
              proposalText: { en: 'Can deliver in 2 days', ar: '' },
              completedTime: null,
            },
          ],
        })
  ...
  makeSection('Admin Requests', 'Moderation tooling for service requests.', [
    {
      ...
      description: describe(
        'Joins creator info, escrow funded flag and promotion snapshot, counts total applications (offers), and returns summary cards.',
        null,
        fmt({
          docs: [
            {
              _id: '6502...',
              title: { en: 'Need a bilingual landing page' },
              promoted: true,
              escrowFunded: true,
              creatorName: 'Omar',
    ...
    },
    {
      ...
      auth: 'admin',
      description: describe(
        'Includes requester profile, attachments, promotion/escrow info, and applicants with bidder profile snapshots.',
        null,
        fmt({
          request: {
            _id: '6502abcdef1234567890cdef',
            ...
            requester: {
              ...
              phone: '+96550002222',
              occupation: 'Marketer',
              location: { addressLine: 'Kuwait City' },
              rating: 4.6,
              ratingCount: 10,
              method: 'email',
            },
          ...
          applicants: [
            {
              ...
              status: 'pending',
              coverLetter: { en: 'Can deliver in 1 week' },
            },
          ],
        })
      ),
  ...
  makeSection('Admin Transactions & Payments', 'Ledger, payouts, analytics for finance.', [
    {
      ...
      description: describe(
        'Paginated list of transactions with optional filters on `status`, `type`, `paymentMethod`, `userId`, `escrow`. Includes enriched itemName, paymentMethodLabel and escrow summary.',
        null,
        fmt({
          data: [
            {
              ...
              status: 'completed',
              escrow: { hasEscrow: false },
              user: { username: 'Hassan', email: 'seller@example.com' },
    ...
    },
    {
      ...
      auth: 'admin',
      description: describe(
        'Aggregates totals (total transactions, monthly revenue + %, failed counts, pending escrow amount).',
        null,
        fmt({
          totalTransactions: 452,
          totalRevenue: { value: 18050, monthlyChangePct: 12.3 },
  ...
  makeSection('Admin Escrow', 'Monitoring + overrides for escrow accounts.', [
    {
      ...
      description: describe(
        'Lists escrow records with type, item name, payer/recipient, amount, payment method and status for quick triage.',
        null,
        fmt({
          data: [
            {
              ...
              payer: { username: 'Omar', email: 'buyer@example.com' },
              recipient: { username: 'Hassan', email: 'seller@example.com' },
            },
          ],
    ...
    },
    {
      ...
      auth: 'admin',
      description: describe(
        'Returns escrow, payer/recipient info, item name, release history, and ledger history.',
        null,
        fmt({
          escrow: {
